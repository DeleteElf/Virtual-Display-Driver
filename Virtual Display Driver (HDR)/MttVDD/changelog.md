##### 1.0.26.071001
1. Improved IddCxVersionQuery to support command-line execution of pipe reload_driver.
2. Script upgrade and optimization.
3. Added official display driver development documentation.
4. Added support for dual monitors.
5. XML configuration reading is no longer supported; only option.txt is now supported.
